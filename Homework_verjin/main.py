...
parser.add_argument('--num_epochs', dest='num_epochs', type=int, default=20, help='epochs to train')
parser.add_argument('--train_batch_size', dest='train_batch_size', type=int, default=128, help='number of elements in a training batch')
parser.add_argument('--val_batch_size', dest='val_batch_size', type=int, default=128, help='number of elements in a validation batch')
parser.add_argument('--test_batch_size', dest='test_batch_size', type=int, default=128, help='number of elements in a testing batch')
